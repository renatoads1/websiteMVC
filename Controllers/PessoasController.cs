...
namespace Weba2mvc.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public PessoasController(Weba2mvcContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Sobrenome,Apelido,Idade")] Pessoas pessoas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sobrenome,Apelido,Idade")] Pessoas pessoas)
        {
            if (id != pessoas.Id)
            {
                return NotFound();
